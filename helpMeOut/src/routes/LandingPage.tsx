...
const LandingPage = () => {
  return (
    <div className="bg-slate-200 w-full h-screen font-custom">
        <nav className="flex justify-between items-center h-24 p-12 px-12 bg-white max-sm:text-xs max-sm:px-8">
        ...
        <section className="bg-white flex justify-center pt-28 h-4/5 mb-6 pb-12 max-sm:w-full max-sm:h-max max-sm:pt-12">
            <div className="w-10/12 bg-blue-40 flex justify-between gap-4 max-sm:flex-col-reverse">
                <div className="w-2/6 items-center justify-center m-auto max-sm:w-full">
                    <h1 className="font-bold text-5xl my-5 w-5/6 max-sm:w-full">Show Them Don’t Just Tell</h1>
                    ...
                    <button className="h-20 w-72  rounded-lg bg-[#120B48] flex justify-center items-center gap-4 text-white">Install HelpMeOut <img src={arrow} alt="" /></button>
                </div>
                <div className=" w-4/6 max-sm:w-full">
                    <div className="w-5/6 h-full m-auto flex gap-2 items-center">
                        ...
                        <div><img src={photo3} className="rounded-lg"/></div>
                    </div>
                </div>
            </div>
        </section>
